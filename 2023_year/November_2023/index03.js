...
var deckRevealedIncreasing = function (deck) {
    ...
    // run the while loop untill stack.length is greater then 0
    while (stack.length > 0) {

        // remove the last element from the array queue using pop() amnd add at first in array queue using unshift()
        queue.unshift(queue.pop());

        // remove the last element from the array stack using pop() amnd add at first in array queue using unshift()
